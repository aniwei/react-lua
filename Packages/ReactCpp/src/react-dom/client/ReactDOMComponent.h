...
class ReactDOMComponent
  : public ReactDOMInstance,
    public std::enable_shared_from_this<ReactDOMComponent> {
public:
  ReactDOMComponent(
  ...
  void appendChild(std::shared_ptr<ReactDOMInstance> child) override;
  void removeChild(std::shared_ptr<ReactDOMInstance> child) override;
